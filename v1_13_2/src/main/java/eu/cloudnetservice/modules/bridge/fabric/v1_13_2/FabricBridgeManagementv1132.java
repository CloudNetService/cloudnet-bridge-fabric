...
package eu.cloudnetservice.modules.bridge.fabric.v1_13_2;
...
public final class FabricBridgeManagementv1132 extends BaseFabricBridgeManagement<ServerPlayerEntity> {
   ...
   */
  public FabricBridgeManagementv1132(@NotNull BridgeAccessorSpec<ServerPlayerEntity> bridgeAccessorSpec) {
  ...
  public @NotNull BiFunction<ServerPlayerEntity, String, Boolean> permissionFunction() {
    return (player, _) -> player.method_15592(4);
  }
  ...
  public @NotNull Optional<ServiceInfoSnapshot> fallback(
    ...
    return this.fallback(player.getUuid(), currServer, null, _ -> player.method_15592(4));
  }
