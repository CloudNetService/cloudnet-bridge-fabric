...
package eu.cloudnetservice.modules.bridge.fabric.v1_14_4;
...
public final class FabricBridgeManagementv1144 extends BaseFabricBridgeManagement<ServerPlayerEntity> {
   ...
   */
  public FabricBridgeManagementv1144(@NotNull BridgeAccessorSpec<ServerPlayerEntity> bridgeAccessorSpec) {
  ...
  public @NotNull BiFunction<ServerPlayerEntity, String, Boolean> permissionFunction() {
    return (player, _) -> player.allowsPermissionLevel(4);
  }
  ...
  public @NotNull Optional<ServiceInfoSnapshot> fallback(
    ...
    return this.fallback(player.getUuid(), currServer, null, _ -> player.allowsPermissionLevel(4));
  }
