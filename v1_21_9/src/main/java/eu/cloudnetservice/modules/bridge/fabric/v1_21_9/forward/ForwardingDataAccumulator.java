...
package eu.cloudnetservice.modules.bridge.fabric.v1_21_9.forward;
...
public final class ForwardingDataAccumulator {
  ...
  public @NotNull GameProfile toGameProfile(@NotNull String name) {
    var profileProperties = this.properties.stream().collect(Collectors.collectingAndThen(
      Multimaps.toMultimap(Property::name, Function.identity(), HashMultimap::create),
      PropertyMap::new));
    return new GameProfile(this.uniqueId, name, profileProperties);
  }
}
